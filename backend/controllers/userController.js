...
if (existingAppointment) {
    ...
    <div style="font-family: Arial; padding: 20px;">
        ...
        <div style="margin-top:20px; padding:15px; background:#f5f5f5; border-radius:10px;">
            ...
            <p><b>Doctor:</b> ${docData.name}</p>

            <p><b>Speciality:</b> ${docData.speciality}</p>

        </div>

        <p style="margin-top:20px;">
            Thank you for choosing
            <b>Doc-Connect Healthcare</b>.
        </p>
...
const cancelAppointment = async (req, res) => {
    ...
    appointmentData.status === "prescription-added"
) {
    return res.json({
        success: false,
...
const getUserPrescriptions = async (req, res) => {
    ...
    try {
        ...
        const prescriptions =
            await prescriptionModel.find({ userId })
...
const verifyStripe = async (req, res) => {
    ...
    <div style="font-family: Arial; padding: 20px;">
        ...
        <p>
            Hello <b>${appointmentData.userData.name}</b>,
        </p>

        <p>
            Your payment for appointment with
            <b>Dr. ${appointmentData.docData.name}</b>
            was completed successfully.
        </p>

        <div style="margin-top:20px; padding:15px; background:#f5f5f5; border-radius:10px;">

            <p><b>Amount Paid:</b> ₹${appointmentData.amount}</p>
